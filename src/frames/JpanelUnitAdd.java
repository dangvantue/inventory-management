...
public class JpanelUnitAdd extends JPanel {
	...
	public JpanelUnitAdd() {
		...
		lblNewLabel.setIcon(new ImageIcon(JpanelUnitAdd.class.getResource("/resources/Business-Org-Unit-icon.png")));
