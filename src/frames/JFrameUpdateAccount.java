...
public class JFrameUpdateAccount extends JFrame {
	...
	public JFrameUpdateAccount() {
		...
		jpasswordFieldPassword.setBounds(177, 108, 159, 26);
		...
		jtextFieldFullName.setBounds(177, 139, 159, 26);
		panel.add(jtextFieldFullName);
		
		jtextFieldAddress = new JTextField();
		jtextFieldAddress.setColumns(10);
		jtextFieldAddress.setBounds(177, 234, 159, 26);
		...
		jcomboBoxRoleAccount.setBounds(177, 297, 159, 27);
		panel.add(jcomboBoxRoleAccount);
		
		JButton jbtnLogin = new JButton("");
		jbtnLogin.setIcon(new ImageIcon(JFrameUpdateAccount.class.getResource("/resources/Exit.png")));
		...
		jbtnAccount.setIcon(new ImageIcon(JFrameUpdateAccount.class.getResource("/img/register1.jpg")));
		jbtnAccount.setBounds(0, 0, 421, 409);
		panel.add(jbtnAccount);
				
	}
	
	public JFrameUpdateAccount(Map<String, Object> data) {
		this();
		this.data = data;
		loadDataCombobox();
		loadData();
