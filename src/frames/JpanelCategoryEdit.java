...
public class JpanelCategoryEdit extends JPanel {
	...
	public JpanelCategoryEdit() {
		...
		lblNewLabel_3.setIcon(new ImageIcon(JpanelCategoryEdit.class.getResource("/resources/Profile.png")));
	...
	public JpanelCategoryEdit (Map<String,Object> data) {
		this();
		this.data = data;
		loadData();
	...
	private void loadData() {
		...
		CategoryModel categorymodel = new CategoryModel();
		Category category = categorymodel.findId(id);	
